...
STAN_MODELS_FOLDER <- "stan_models/"
...
# basic_emax_fit <- stan(file=file.path(STAN_MODELS_FOLDER, "emax_model.stan"), data = input_data, chains=4, 
#                        warmup=1000, iter=2000, cores = 1, control = list(adapt_delta = 0.95), seed=100)
adv_emax_fit <- stan(file=file.path(STAN_MODELS_FOLDER, "emax_model_with_e0.stan"), data = input_data, chains=4,
                     warmup=1000, iter=2000, cores = 1, control = list(adapt_delta = 0.95), seed=100)
```
